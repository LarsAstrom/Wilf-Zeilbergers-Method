...
Now, let us derive how to get the polynomial $f_k$ such that \ref{Eq: Theory,Gosper,step2} is fulfilled. \todo{CONTINUE THIS DERIVATION} \todo{CAN WE FIND THE DEGREE?}
